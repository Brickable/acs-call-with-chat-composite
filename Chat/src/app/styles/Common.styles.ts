...
export const elevatedCardContainerStyle = mergeStyles({
  boxShadow: '2px 4px 8px 0 rgba(0,0,0,0.3), inset 0 1px 2px 0 rgba(255,255,255,0.5)'
});

export const errorChatContainerStyle = mergeStyles({
  height: '100%',
  width: '100% ',
...
export const errorChatTitleStyle = mergeStyles({
  fontWeight: 600,
  fontSize: '1.375rem', // 22px
  width: '20rem'
});

export const loadingLabelStyles = mergeStyles({
  fontSize: '16px'
});
